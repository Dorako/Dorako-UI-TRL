...
export default () => {
   ...
   return {
      ...
      base: "/modules/dorako-ui-trl/", // Base module path that 30001 / served dev directory.
      ...
      server: {
         ...
         open: "/game",
         proxy: {
            "^(/modules/dorako-ui-trl/lang)": "http://localhost:30000",
            "^(?!/modules/dorako-ui-trl/)": "http://localhost:30000",
